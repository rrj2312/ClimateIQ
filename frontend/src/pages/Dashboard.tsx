    ...
    <div className="container mx-auto max-w-5xl px-6 py-16">
      ...
      <section className="mb-20 text-center">
        ...
        <p className="mx-auto mb-8 max-w-2xl text-lg text-muted-foreground">
          ClimateIQ turns six months of climate due diligence into a two minute evidence trail.
        </p>
      ...
      <section className="mb-20">
        <h2 className="mb-8 text-center text-2xl font-bold">What ClimateIQ Does</h2>
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((f) => (
            <div
              key={f.title}
              className={`rounded-xl bg-card p-6 transition-shadow duration-200 ${f.shadow}`}
            >
      ...
      <section>
        ...
        <div className="grid gap-4 md:grid-cols-5">
          {steps.map((step, i) => (
            <div
              key={i}
              className={`rounded-xl bg-card p-5 transition-shadow duration-200 ${
