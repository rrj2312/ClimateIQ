...
const AuditReport = () => {
  ...
  const report = location.state?.report || MOCK_REPORT;

  if (!report) return <Navigate to="/submit" />;
  ...
  return (
    <div className="container mx-auto max-w-5xl px-6 py-16">
      {/* Overall Score */}
      <div className={`mx-auto mb-8 max-w-sm rounded-xl p-8 text-center ${scoreBg(report.overall_score)} shadow-blue`}>
      ...
      {/* Executive Summary */}
      <div className="mb-10 rounded-xl bg-card p-6 shadow-green">
      ...
      <div className="mb-10 grid gap-6 md:grid-cols-2">
        ...
        {/* Progress bars */}
        <div className="rounded-xl bg-card p-6 shadow-green">
      ...
      {/* Red Flag Engine */}
      <div className="mb-10 rounded-xl bg-card p-6 shadow-blue">
      ...
      <div className="mb-10 rounded-xl bg-card p-6 shadow-green">
        ...
        <div className="grid gap-2 sm:grid-cols-2">
          {report.investor_match.map((inv: any) => (
            <div key={inv.type} className="flex items-center gap-2 rounded-lg border p-3">
